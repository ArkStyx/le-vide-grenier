...
public class UtilitaireFiltre {
	...
	public static final String IMMOBILIER_CLASSE_ENERGIE_D = "D";
	public static final String IMMOBILIER_CLASSE_ENERGIE_E = "E";
	public static final String IMMOBILIER_CLASSE_ENERGIE_F = "F";
	public static final String IMMOBILIER_CLASSE_ENERGIE_G = "G";

	public static final String IMMOBILIER_TYPE_BIEN_MAISON = "Maison";
	public static final String IMMOBILIER_TYPE_BIEN_APPARTEMENT = "Appartement";
	public static final String IMMOBILIER_TYPE_BIEN_TERRAIN = "Terrain";
	public static final String IMMOBILIER_TYPE_BIEN_PARKING = "Parking";
	public static final String IMMOBILIER_TYPE_BIEN_AUTRE = "Autre";

	public static final String IMMOBILIER_TYPE_VENTE_ANCIEN = "Ancien";
	...
	public static final String MAISON_TYPE_OUTILS_DE_CUISINE = "Outils De Cuisine";
	public static final String MAISON_TYPE_PRODUITS_DE_BEAUTE = "Produits De Beauté";
